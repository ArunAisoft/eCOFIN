...
{
    public class ExistingCreditNoteDto
    {
    ...
    public class CreditNoteWithDetailsDto
    {
        public CreditNotesDto Header { get; set; } = new CreditNotesDto();
        public List<CrdnDetailsDto> Details { get; set; } = new List<CrdnDetailsDto>();
    }

    public class CreditNotesRequestDto
    {
        public CreditNotesDto VoucherData { get; set; } = new();
        public List<CrdnDetailsDto> Details { get; set; } = new();
