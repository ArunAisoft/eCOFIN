...
{
    public class ExistingDebitNoteDto
    {
    ...
    public class DebitNoteWithDetailsDto
    {
        public DebitNotesDto Header { get; set; } = new DebitNotesDto();
        public List<DebnDetailsDto> Details { get; set; } = new List<DebnDetailsDto>();
    }

    public class DebitNotesRequestDto
    {
        public DebitNotesDto VoucherData { get; set; } = new();
        public List<DebnDetailsDto> Details { get; set; } = new();
