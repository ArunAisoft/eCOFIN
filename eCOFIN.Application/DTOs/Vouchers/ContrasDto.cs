...
{
    public class ExistingContraDto
    {
    ...
    public class ContraWithDetailsDto
    {
        public ContrasDto Header { get; set; } = new ContrasDto();
        public List<ContraDetailsDto> Details { get; set; } = new List<ContraDetailsDto>();
    }

    public class ContrasRequestDto
    {
        public ContrasDto VoucherData { get; set; } = new();
        public List<ContraDetailsDto> Details { get; set; } = new();
