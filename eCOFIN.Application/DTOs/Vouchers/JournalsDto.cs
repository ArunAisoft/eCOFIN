...
{
    public class ExistingJournalDto
    {
    ...
    public class JournalWithDetailsDto
    {
        public JournalsDto Header { get; set; } = new JournalsDto();
        public List<JrnlDetailsDto> Details { get; set; } = new List<JrnlDetailsDto>();
    }

    public class JournalsRequestDto
    {
        public JournalsDto VoucherData { get; set; } = new();
        public List<JrnlDetailsDto> Details { get; set; } = new();
