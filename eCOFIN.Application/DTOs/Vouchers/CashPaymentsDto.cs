...
{
    public class ExistingCashPaymentDto
    {
    ...
    public class CashPaymentWithDetailsDto
    {
        public CashPaymentsDto Header { get; set; } = new CashPaymentsDto();
        public List<CashpDetailsDto> Details { get; set; } = new List<CashpDetailsDto>();
    }

    public class CashPaymentsRequestDto
    {
        public CashPaymentsDto VoucherData { get; set; } = new();
        public List<CashpDetailsDto> Details { get; set; } = new();
