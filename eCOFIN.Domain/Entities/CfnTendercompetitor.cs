...
[Table("CFN_TENDERCOMPETITOR")]
public partial class CfnTendercompetitor
{
    [Key]
    ...
    [Column("TENDERFORMDT", TypeName = "datetime")]
    public DateTime? Tenderformdt { get; set; }

    [Column("CTRL_TENDERNO")]
    [StringLength(20)]
    [Unicode(false)]
    public string? CtrlTenderno { get; set; }
