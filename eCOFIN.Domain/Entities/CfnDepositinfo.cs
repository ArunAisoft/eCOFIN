...
[Table("CFN_DEPOSITINFO")]
public partial class CfnDepositinfo
{
    [Key]
    ...
    [Column("GURENTEEAMT", TypeName = "numeric(14, 2)")]
    public decimal? Gurenteeamt { get; set; }

    [Column("TOTALPOVALUE", TypeName = "numeric(14, 2)")]
