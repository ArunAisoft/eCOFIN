...
[Table("CFN_FINANCIALINST")]
public partial class CfnFinancialinst
{
    //[Key]
    [Column("FINANCIALINSTCODE")]
    [StringLength(20)]
    [Unicode(false)]
    public string Financialinstcode { get; set; } = null!;
    ...
    [Column("SANCTIONAMNT", TypeName = "numeric(14, 2)")]
    public decimal Sanctionamnt { get; set; }

    [Column("INTERESTRATE", TypeName = "numeric(10, 2)")]
    public decimal? Interestrate { get; set; }

    [Column("OVERDUEINTEREST", TypeName = "numeric(5, 2)")]
