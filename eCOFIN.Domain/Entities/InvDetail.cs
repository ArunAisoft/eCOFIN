...
[Table("inv_detail")]
//[Index("RowNo", Name = "IX_inv_detail", IsUnique = true)]
public partial class InvDetail
{
    ...
    [StringLength(100)]
    [Unicode(false)]
    public string? OrderWoNo { get; set; }
    ...
    [Column("Cust_SlNo_Old")]
    public double? CustSlNoOld { get; set; }
    ...
    [Column("BCD_Rate")]
    public double BcdRate { get; set; }

    [Column("SWS_Rate")]
    public double SwsRate { get; set; }
}
