...
[Table("CFN_CREDITGENFACTOR")]
public partial class CfnCreditgenfactor
{
    [Key]
    ...
    [Column("UNIT", TypeName = "numeric(14, 2)")]
    public decimal? Unit { get; set; }

    [Column("TOTALCOMPUTEDVALUE", TypeName = "numeric(14, 2)")]
    public decimal? Totalcomputedvalue { get; set; }
}
