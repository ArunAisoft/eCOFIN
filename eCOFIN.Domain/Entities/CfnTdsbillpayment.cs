...
[Table("cfn_tdsbillpayment")]
public partial class CfnTdsbillpayment
{
    [Key]
    ...
    [Column("billamountadjusted", TypeName = "numeric(14, 2)")]
    ...
    [Column("onholdamountadjusted", TypeName = "numeric(14, 2)")]
    ...
    [Column("billpayment_flag")]
    [StringLength(1)]
    [Unicode(false)]
    public string? BillpaymentFlag { get; set; }
