...
[Table("CFN_HSTQUOTATION")]
public partial class CfnHstquotation
{
    [Key]
    ...
    [Column("QUOTATION_DATE", TypeName = "datetime")]
    ...
    [StringLength(1)]
    [Unicode(false)]
    public string? Enquirybase { get; set; }
    ...
    [Column("TOTALQUOTVALUE", TypeName = "numeric(14, 2)")]
    public decimal? Totalquotvalue { get; set; }
