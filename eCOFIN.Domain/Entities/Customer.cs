...
public partial class Customer
{
    ...
    [StringLength(1)]
    [Unicode(false)]
    public string EmailInvCopy { get; set; } = null!;
    ...
    [Column("Sea_DeliveryTerms")]
    [StringLength(120)]
    [Unicode(false)]
    public string? SeaDeliveryTerms { get; set; }

    [Column("Sea_PaymentType")]
    [StringLength(25)]
    [Unicode(false)]
    public string SeaPaymentType { get; set; } = null!;

    [Column("Sea_CreditDays")]
    public int SeaCreditDays { get; set; }

    [Column("Sea_PaymentTerms")]
    [StringLength(120)]
    [Unicode(false)]
    public string? SeaPaymentTerms { get; set; }

    [Column("Air_DeliveryTerms")]
    [StringLength(120)]
    [Unicode(false)]
    public string? AirDeliveryTerms { get; set; }

    [Column("Air_PaymentType")]
    [StringLength(25)]
    [Unicode(false)]
    public string AirPaymentType { get; set; } = null!;

    [Column("Air_CreditDays")]
    public int AirCreditDays { get; set; }

    [Column("Air_PaymentTerms")]
    [StringLength(120)]
    [Unicode(false)]
    public string? AirPaymentTerms { get; set; }

    [Column("Customer_SubType")]
    [StringLength(25)]
    [Unicode(false)]
    public string CustomerSubType { get; set; } = null!;
    ...
    [Column("Attach_InvoiceReport")]
    [StringLength(1)]
    [Unicode(false)]
    public string AttachInvoiceReport { get; set; } = null!;

    [Column("Club_Orders")]
    [StringLength(1)]
    [Unicode(false)]
    public string ClubOrders { get; set; } = null!;

    [Column("EORINo_Required")]
    [StringLength(1)]
    [Unicode(false)]
    public string EorinoRequired { get; set; } = null!;

    [Column("CustName_CaseName")]
    [StringLength(50)]
    [Unicode(false)]
    public string? CustNameCaseName { get; set; }

    [Column("AnnexureInvoice_Attach")]
    [StringLength(1)]
    [Unicode(false)]
    public string AnnexureInvoiceAttach { get; set; } = null!;
    ...
    [Column("EndCustomer_Required")]
    [StringLength(1)]
    [Unicode(false)]
    public string EndCustomerRequired { get; set; } = null!;

    [Column("Former_Coname")]
    [StringLength(100)]
    [Unicode(false)]
    public string? FormerConame { get; set; }

    [Column("Former_Coname_DateTill", TypeName = "datetime")]
